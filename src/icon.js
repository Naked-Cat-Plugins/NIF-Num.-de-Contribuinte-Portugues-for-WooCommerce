...
export const Icon = () => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
			...
			<path d="M19 14.8h1.9l3.4 6v-6H26v8.6h-1.8l-3.5-6.1v6.1H19v-8.6zm10.3 8.7h-1.8v-8.6h1.8v8.6zm1.7-8.6h6.2v1.5h-4.4v2h3.8v1.5h-3.8v3.6H31v-8.6zM6 21.2h3v2.1H6z"></path>
		</svg>
	);
};
